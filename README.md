...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
     printf("I love footballDharun Arulselvan\n");
     printf("212224220024\n");
     HAL_Delay(500);
  }
}
...
## Output screen shots of Serial port utility   :
 <img width="1919" height="1199" alt="Screenshot 2026-05-11 120030" src="https://github.com/user-attachments/assets/8a975171-8dac-42b0-9396-cc3611ac73c3" />
